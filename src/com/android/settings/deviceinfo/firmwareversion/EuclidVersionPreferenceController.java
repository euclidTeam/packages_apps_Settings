/*
 * Copyright (C) 2024 EuclidOS Project
 *
...
public class EuclidVersionPreferenceController extends BasePreferenceController {
    ...
    public int getAvailabilityStatus() {
        return !TextUtils.isEmpty(SystemProperties.get(EUCLID_VERSION_PROPERTY)) ? AVAILABLE : UNSUPPORTED_ON_DEVICE;
    }

    @Override
    public CharSequence getSummary() {
        return SystemProperties.get(EUCLID_VERSION_PROPERTY,
